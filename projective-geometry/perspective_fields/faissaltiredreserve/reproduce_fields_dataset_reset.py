...
def get_test_dataloaders(test_image_paths, unconfident_image_paths, misclassified_image_paths, class_to_idx):  
    ...
    unconfident_image_paths = sample(unconfident_image_paths,500) #int(len(easy_image_paths)*0.1)) #eeeee
    misclassified_image_paths = sample(misclassified_image_paths,500) #int(len(easy_image_paths)*0.1)) #eeeee
    # for debug98933
